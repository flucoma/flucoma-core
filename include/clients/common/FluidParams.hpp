...
Templates for defining and querying parameters of fluid decomposition client
objects, to enable argument checking from host wrappers
...
/**
 ...
 Exists so that we can have polymorphic containers of Params, irrespective of
 their mix-ins
 **/
...
//
//    template<typename ... U>
//    MixParam(std::string name, U...args): Param(name),
//    Attr<T>(std::forward<U>(args))...{}
//
