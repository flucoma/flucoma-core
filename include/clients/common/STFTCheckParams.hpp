...
std::tuple<bool, std::string> checkFFTArguments(client::Instance &windowSize,
                                                client::Instance &hopSize,
                                                client::Instance &fftSize) {
...
//            {
//
//                feedback << fft_size << " is not a sensible FFT Size, setting
//                to default (" << 2048 << ")\n";
//
...
//                    feedback <<  "fft_size: " <<  fft_size << "is not a power
//                    of two. Increasing fft_size to nearest power of two (" <<
//                    m_fft_size << ")\n";
//
//                }
//            }
...
//            {
//                feedback << "Window size can't be greater than fft size:
//                decreasing window size  to " << fft_size <<'\n'; m_window_size
//                = fft_size;
//            }
//
//            if(hopsize > m_fft_size / 2)
//            {
//                feedback << "An overlap factor < 2 may give unpredictable
//                results";
//            }
//
