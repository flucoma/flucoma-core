...
TEST_CASE("GriffinLim is repeatable with user-supplied random seed")
{
  ...
  Tensor complexIn{{0.5, 0.4}, {0.1, 1.1}, {0.7, 0.8}, {0.3, 0.0}, {1.0, 0.9}, {0.2, 0.6}};

  std::vector Hs(3, Tensor(6, 6));

  algo.process(Hs[0], sourceMag, 3, 2, 7, 42); //arrrrhhhh
  algo.process(Hs[1], sourceMag, 3, 2, 7, 42);
  algo.process(Hs[2], sourceMag, 3, 2, 7, 5063);
