...
double paramDetectThreshHi =
    3.0; // The threshold for detection (in multiples of the model deviation)
...
// This is broken right now - SET FALSE AND DO NOT EXPOSE - turning it on will
// produce worse results (should make things better)
...
// This is just for the test app, but is used to turn the corruption process
// on/off if you want to test purely on the inherent transients or fake
// transients
...
int main(int argc, const char *argv[]) {
  ...
  extractor.setDetectionParameters(paramDetectPower, paramDetectThreshHi,
